...
let fa_fa_arrow = document.querySelectorAll(".fa fa-arrow-up");
...
setTimeout(() => {
    ...
    let arr_hello = ["hei, matkaaja!", "tere, reisija!", "hei, reisende!", "hej, resenär!", "hej, rejsende!", "здравей, пътешественико!"]
    GetInfo(answer, arr_country, arr_hello, promo);
    GetInfo(answer2, arr_country, arr_hello, footer);
    
}, 600);

function GetInfo(info, arr_c, arr_h, el) {
